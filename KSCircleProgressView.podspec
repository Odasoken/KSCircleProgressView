#
#  Be sure to run `pod spec lint KSCircleProgressView.podspec' to ensure this is a
...
s.description  = "KSCircleProgressView: a lightweight ProgressView that display progress in circle style."
  ...
  s.author             = { "abredo" => "" }
  # Or just: s.author    = "abredo"
  # s.authors            = { "abredo" => "" }
  # s.social_media_url   = "http://twitter.com/abredo"
  ...
  s.source       = { :git => "https://github.com/abredo/KSCircleProgressViewDemo.git", :tag => "0.0.2" }
